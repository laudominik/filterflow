...
@jsonObject({name:"AdditionTransform"})
export default class AdditionTransform extends BinaryTransform {
    constructor(){
        super("addition", fs);
    }
    ...
    public infoView(): string | null {
        return "Adds pixel values for each channel: color1 + color2"
    }
